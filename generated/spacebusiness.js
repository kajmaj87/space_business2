...
var wasmBinaryFile;
  wasmBinaryFile = 'spacebusiness.wasm';
...
var ASM_CONSTS = {
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],init:function() {
        ...
        var pthreadMainJs = locateFile('spacebusiness.worker.js');
...
var proxiedFunctionTable = [null,exitOnMainThread,pthreadCreateProxied,___syscall_ioctl,_environ_get,_environ_sizes_get,_fd_close,_fd_read,_fd_seek,_fd_write];
...
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 30340;
